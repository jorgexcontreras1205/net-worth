function calculateNetWorth() {
    ...
    const house1Debt = parseFloat(document.getElementById("house1-debt").value);
    
    const house2Value = parseFloat(document.getElementById("house2-value").value);
    const house2Debt = parseFloat(document.getElementById("house2-debt").value);
    
    const house3Value = parseFloat(document.getElementById("house3-value").value);
    const house3Debt = parseFloat(document.getElementById("house3-debt").value);
    ...
    // Calculating future debts (assuming debts remain the same for now)
